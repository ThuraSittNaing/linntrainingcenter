...
$fee=$_POST['fee'];
$sec=$_POST['sec'];
$result = mysqli_query($conn, "UPDATE course SET  course_id='$id',course_name='$name', course_desc='$desc',course_photo='$image',duration='$duration',fees='$fee',section='$sec' WHERE id=
'$id'");
// var_dump($result);
