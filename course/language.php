...
<div class="container ">
 <h5 style="color:#751B08;">English Language Course</h5><br>
    <div class="row">
    
        <div class="flip-box col-lg-4 col-sm-12">
            <img src="../image/eng.jpg"  width="260px" height="150px">
        ...
        <div class="flip-box col-lg-2 col-sm-12" >
         <center>  Fee:50000K
                   Dduration:3Months
          </center>
        </div>
...
<div class="container ">
 <h5 style="color:#751B08;">Chinese Language Course</h5><br>
    <div class="row">
    
        <div class="flip-box col-lg-4 col-sm-12">
            <img src="../image/chinese.jpg"  width="260px" height="150px">
        </div><br><br><br><br><br><br><br><br>
            <!-- <div class="flip-box-back">
            <img src="../image/mobile4.jpg" width="400px" height="300px">
            </div> -->
